...
| Project | Description |
| --- | --- |
| [Go2Office](https://github.com/abaiao-r/Go2Office) | <details> <summary> Kotlin \| Jetpack Compose \| Android Development </summary> <br> **Objective:** Create an app that optimizes the days you ave to go to the office to comply with hybrid rules of the office. <br> **Relevance:** This project covers foundational concepts in android and kotlin development. </details> |
| [Python_for_Data_Science](https://github.com/abaiao-r/Python_for_Data_Science) | <details> <summary> Python Programming \| Data Science Applications </summary> <br> **Objective:** Explore the Python programming language, focusing on its high-level, object-oriented features and its extensive libraries that are beneficial for data science. <br> **Relevance:** This project covers foundational to advanced concepts in Python, enabling learners to effectively utilize the language for data analysis and manipulation, which is crucial in the field of data science. </details> |
...
| [ft_transcendence](https://github.com/abaiao-r/ft_transcendence) | <details> <summary> Web development (JavaScript \| HTML \| CSS) \| Full-stack development </summary> <br> **Objective:** Build a web-based platform for competitive multiplayer games. <br> **Relevance:** Reduced time to write use cases tests from 15 min to 5 min per use case test by leveraging AI to reduce manual effort. |
| [Automated-Generation-Test-Cases-With-Gen-AI](https://github.com/abaiao-r/Axians-Hackthon) | <details> <summary> Python \| Flask \| Vue.js \| TypeScript \| Generative AI  </summary> <br> **Objective:** Automate test case generation from user stories using OpenAI's ChatGPT-4 to streamline software testing processes for Axians company. <br> **Relevance:** Focus on web development and full-stack development. |
